...
- `changelog.html` — Complete 45-entry 2026.3.0 release notes since 2026.2.6, matching the release Markdown with shorter wording. Fixes are grouped into storage/recovery, player state/moderation, Discord/integrations, and chat/menus; upgrade requirements and known limits remain visible.
